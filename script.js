...
const stopTryingMessage = document.getElementById("stopTryingMessage");
...
function moveNoButton() {
    ...
    if (timesNoBtnMoved % 5 === 0) {
        promptCard.style.display = "none";
        stopTryingMessage.classList.add("show");

        setTimeout(() => {
            stopTryingMessage.classList.remove("show");
